...
class TestNextMiniBatch(unittest.TestCase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.labels = np.array([[0, 0], [1, 1], [2, 2], [3, 3], [4, 4]])
  ...
  def test_Second(self):
    ...
    expected_labels = np.array([[2, 2], [3, 3]])
...
class TestPrepareData(unittest.TestCase):
  ...
  def test_NoMaxLen(self):
    seqs = [[1, 2], [1, 2, 3, 4]]
    labels = [[0, 0], [1, 0]]
    expected_x = np.array([[1, 2, 0, 0], [1, 2, 3, 4]])
    expected_labels = np.array([[0, 0], [1, 0]])
  ...
  def test_WithMaxLen(self):
    seqs = [[1, 2], [1, 2, 3], [1, 2, 3, 4]]
    labels = [[0, 0], [0, 1], [1, 1]]
    expected_x = np.array([[1, 2, 0], [1, 2, 3]])
    expected_labels = np.array([[0, 0], [0, 1]])
